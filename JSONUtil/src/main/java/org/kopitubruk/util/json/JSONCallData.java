...
class JSONCallData
{
    ...
    {
        this.cfg = cfg;
        objStack = cfg.isDetectDataStructureLoops() ? new ArrayList<>() : null;
    }
    ...
    DateFormat[] getDateFormatters()
    {
        if ( dateFormatters == null ){
            ...
            dateFormatters[0] = new SimpleDateFormat("yyyy-MM-dd'T'HH:mm:ss.SSSXXX");
            dateFormatters[1] = new SimpleDateFormat("yyyy-MM-dd'T'HH:mm:ss.SSS");
            dateFormatters[2] = new SimpleDateFormat("yyyy-MM-dd'T'HH:mm:ssXXX");
